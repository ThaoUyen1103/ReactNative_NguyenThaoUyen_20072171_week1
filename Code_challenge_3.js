...
var koalasAvg = (Koalas_Score[0] + Koalas_Score[1] + Koalas_Score[2]) / 3;


var reqScoreDol = dolphinsAvg >= 100;
var reqScoreKoa = koalasAvg >= 100;

console.log("Coding Challenge #3");

if (dolphinsAvg > koalasAvg && reqScoreDol) {
    console.log("Team Dolphins win!", dolphinsAvg.toFixed(1), ">", koalasAvg);
